def startETimer():	
	f_in = open("/home/charles/Desktop/CoojaData/Etimer/TestTime", "r")
	f_outSender = open("/home/charles/Desktop/CoojaData/Etimer/ProperDataSender.txt", "w")
	f_outReceiver = open("/home/charles/Desktop/CoojaData/Etimer/ProperDataReceiver.txt", "w")
	tabReceiver = []
	tabSender = []
	IdleLine = 0
	data = 0
